...
related:
  - ../index.md
  - ../entities/avatar/teaching-methodology.md
...
| **核心知识** | [[concepts/rules/index]] [[concepts/patterns/index]] [[entities/api/index]] |
...
| **输出格式** | 实现方案 → 风险说明 → **代码最后** |
| **核心知识** | [[concepts/rules/index]] [[entities/api/index]] [[entities/avatar/index]] |
...
| **核心知识** | [[entities/avatar/teaching-methodology]] [[entities/avatar/modular-avatar]] |

### 教学触发规则

1. **先读取** [[entities/avatar/teaching-methodology]]（45 条教学原则）
2. **语气切换**：通俗、耐心、使用类比
...
| **核心知识** | [[FACT]] `辅助文件/脚本/auxiliary-script/`（2026-08-18 归档后路径） |
