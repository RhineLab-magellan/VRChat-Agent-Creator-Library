---
title: "Build-Time vs Runtime Separation (构建时与运行时分离)"
category: patterns
...
tags:
  ...
  - event
aliases:
  - "Build-Time vs Runtime Separation (构建时与运行时分离)"
  - build-time-vs-runtime.md
related:
  - ../concepts/patterns/iid-object-identity.md
  - ../concepts/patterns/code-generation-type-erasure.md
  - FACT.md
type: concept
created: 2026-06-20
sources: ULocalization(参考工程)
updated: 2026-06-20
---
...
- [ULocalization（GitHub）](https://github.com/ikuko/ULocalization) — 项目溯源
- [[concepts/patterns/iid-object-identity]] — 配套 ID 映射
- [[concepts/patterns/code-generation-type-erasure]] — 配套类型擦除
- [[FACT]] § ULocalization
...
[ULocalization（GitHub）](https://github.com/ikuko/ULocalization) · [[../concepts/patterns/iid-object-identity.md]] · [[../concepts/patterns/code-generation-type-erasure.md]] · [[FACT|FACT]]
