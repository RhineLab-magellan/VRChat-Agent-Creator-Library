---
title: "Pattern: Event-Driven State Machine"
category: patterns
...
related:
  - ../../entities/world/scene-components/vrc-station.md
  - ../../entities/world/scene-components/vrc-portalmarker.md
  - bit-packed-flags.md
  - exclusive-control-selector.md
  - master-follower-syncer.md
type: concept
created: 2026-06-20
sources: 本地知识库整理
updated: 2026-06-20
...
- [[entities/world/scene-components/vrc-station]] - **典型事件源**:`OnStationEntered` / `OnStationExited` 是本模式的常见事件源,实现"玩家坐下 → 状态机进入 ACTIVE 阶段"的转换
- [[entities/world/scene-components/vrc-portalmarker]] - **多 World 状态机**:Portal Marker 触发的 World 跳转是大型状态转换,可用本模式管理多 World 流程

---

## 相关页面

[[../../entities/world/scene-components/vrc-station.md]] · [[../../entities/world/scene-components/vrc-portalmarker.md]] · [[bit-packed-flags.md]] · [[exclusive-control-selector.md]] · [[master-follower-syncer.md]]
