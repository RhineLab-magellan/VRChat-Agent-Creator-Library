---
title: "IID Object Identity (整数身份映射)"
category: patterns
...
- [[concepts/patterns/slot-parameter-passing]] — 配套的 slot 传参
- [[comparisons/build-time-vs-runtime]] — 配套的 Build-Runtime 分离
- [[FACT]] § ULocalization
...
[ULocalization（GitHub）](https://github.com/ikuko/ULocalization) · [[slot-parameter-passing.md]] · [[../../comparisons/build-time-vs-runtime.md]] · [[FACT|FACT]]
