...
> Reference: [ULocalization（GitHub）](https://github.com/ikuko/ULocalization)
...
- [[concepts/patterns/hash-based-dispatch]] — 配套 hash 分派
- [[comparisons/build-time-vs-runtime]] — 配套 Build-Runtime 分离
- [[FACT]] § ULocalization
...
[ULocalization（GitHub）](https://github.com/ikuko/ULocalization) · [[hash-based-dispatch.md]] · [[../../comparisons/build-time-vs-runtime.md]] · [[FACT|FACT]]
