...
aliases:
  ...
  - 软吸附插值
related:
  - editor-preview-component.md
  - hash-based-dispatch.md
  - inherited-subscriber.md
  - material-propertyblock-safe-update.md
  - unorthodox-patterns.md
type: concept
created: 2026-06-20
sources: "QuickBrown LuraSwitch2(参考工程) — `SliderSwitch.cs` (段への吸着 / SoftDetent)"
updated: 2026-06-20
---
...
[[editor-preview-component.md]] · [[hash-based-dispatch.md]] · [[inherited-subscriber.md]] · [[material-propertyblock-safe-update.md]] · [[unorthodox-patterns.md]]
