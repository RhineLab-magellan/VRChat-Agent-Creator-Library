---
title: "Slot-Based Parameter Passing (槽位参数传递)"
category: patterns
...
tags:
  ...
  - pickup
aliases:
  - "Slot-Based Parameter Passing (槽位参数传递)"
...
- [[concepts/patterns/hash-based-dispatch]] — 配套的 hash 分派
- [[concepts/patterns/code-generation-type-erasure]] — 配套的代码生成
- [[FACT]] § ULocalization
...
[ULocalization（GitHub）](https://github.com/ikuko/ULocalization) · [[hash-based-dispatch.md]] · [[code-generation-type-erasure.md]] · [[FACT|FACT]]
