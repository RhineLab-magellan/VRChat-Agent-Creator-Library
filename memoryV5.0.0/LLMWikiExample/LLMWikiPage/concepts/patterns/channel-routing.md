...
- [[concepts/patterns/slot-parameter-passing]] — 配套参数传递（16 重载）
- [[FACT]] § Sardinal
...
[Sardinal（GitHub）](https://github.com/ikuko/Sardinal) · [[inherited-subscriber.md]] · [[hybrid-subscription-modes.md]] · [[slot-parameter-passing.md]] · [[FACT|FACT]]
