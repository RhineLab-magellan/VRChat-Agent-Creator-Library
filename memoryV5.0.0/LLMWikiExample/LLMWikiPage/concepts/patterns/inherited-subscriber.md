...
> Reference: [Sardinal（GitHub）](https://github.com/ikuko/Sardinal)
...
- [[concepts/patterns/hybrid-subscription-modes]] — 配套双订阅模式
- [[comparisons/build-time-vs-runtime]] — 依赖 Editor 反射
- [[FACT]] § Sardinal
...
[Sardinal（GitHub）](https://github.com/ikuko/Sardinal) · [[channel-routing.md]] · [[hybrid-subscription-modes.md]] · [[../../comparisons/build-time-vs-runtime.md]] · [[FACT|FACT]]
