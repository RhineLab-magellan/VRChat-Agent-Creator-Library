---
title: "Pattern: Fade-Then-Snap（淡入淡出移动）"
category: patterns
...
type: concept
created: 2026-06-20
sources: "QuickBrown LuraSwitch2(参考工程) — `SwitchBoard.cs`"
updated: 2026-06-20
---
...
> Pattern 核心思想(透明→移动→淡入 + 重入 token)在 Udon 沙箱中仍是通用解法
...
[[advanced-sync-patterns.md]] · [[../../comparisons/build-time-vs-runtime.md]] · [[code-generation-type-erasure.md]] · [[hash-based-dispatch.md]] · [[hybrid-subscription-modes.md]]
