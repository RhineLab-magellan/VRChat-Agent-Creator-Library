---
title: "Pattern: Master-Follower Syncer（主从同步器）"
category: patterns
...
type: concept
created: 2026-06-20
sources: "QuickBrown LuraSwitch2(参考工程) — `SwitchSyncer.cs`"
updated: 2026-06-20
---
...
> Pattern 核心思想(Master-Follower + 节流窗口)在 Udon 沙箱中仍是通用解法
...
[[bit-packed-flags.md]] · [[event-driven-state-machine.md]] · [[exclusive-control-selector.md]] · [[advanced-sync-patterns.md]] · [[late-joiner-state-restore.md]]
