---
title: "Pattern: Editor Preview Component（编辑器预览组件）"
category: patterns
...
aliases:
  - 编辑器预览组件
  - "Editor Preview Component（编辑器预览组件）"
related:
...
type: concept
created: 2026-06-20
sources: "QuickBrown LuraSwitch2(参考工程) — `MirrorAreaPreview.cs`, `Collider_AreaPreview.cs`, `HeightOffsetterPreview.cs`"
updated: 2026-06-20
---
...
> Pattern 核心思想([ExecuteAlways] MonoBehaviour + TrackingState + delayCall)在 Udon 沙箱中仍是通用解法
...
[[hash-based-dispatch.md]] · [[inherited-subscriber.md]] · [[advanced-sync-patterns.md]] · [[bit-packed-flags.md]] · [[../../comparisons/build-time-vs-runtime.md]]
