---
title: "Hash-Based Method Dispatch (哈希方法分派)"
category: patterns
...
- [ULocalization（GitHub）](https://github.com/ikuko/ULocalization) — ULocalization 项目溯源
- [[concepts/patterns/slot-parameter-passing]] — 配套的 slot 传参模式
- [[concepts/patterns/code-generation-type-erasure]] — 代码生成策略
- [[FACT]] § ULocalization(参考工程) — 案例研究摘要
- （来源：常见失败案例分析，本地整理） — FAIL-23: `internal` 关键字导致方法随机不可用

---

## 相关页面

[ULocalization（GitHub）](https://github.com/ikuko/ULocalization) · [[slot-parameter-passing.md]] · [[code-generation-type-erasure.md]] · [[FACT|FACT]] · （来源：常见失败案例分析，本地整理）
