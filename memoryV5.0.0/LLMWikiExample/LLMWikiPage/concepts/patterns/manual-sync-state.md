...
related:
  ...
  - ../../entities/world/udon/networking/network-details.md
  ...
  - ../../entities/world/scene-components/vrc-objectsync.md
  - ../../entities/world/scene-components/vrc-enablepersistence.md
...
| 文档 | 关系 |
|------|------|
| [[entities/world/udon/networking/performance]] | **10 条带宽优化规则、合并序列化、位域压缩** |
| [[entities/world/udon/networking/network-details]] | 内部字节细节、Manual 280KB vs Continuous 200B 差异 |
| [[entities/world/udon/networking/variables]] | `[UdonSynced]` 字段类型与序列化大小 |
| [[entities/world/udon/networking/late-joiners]] | Manual Sync 的 Late Joiner 自动同步保证 |
| [[entities/world/udon/networking/ownership]] | Manual 写入的 Owner 权限 |
| [[entities/world/udon/networking/compatibility]] | 字段增删与跨版本兼容 |
| [[entities/world/udon/networking/index]] | Manual vs Continuous 决策树 |
| [[concepts/patterns/bit-packed-flags]] | 8 bool → 1 byte 的位域压缩模式 |
| [[concepts/patterns/late-joiner-state-restore]] | Late Joiner 状态恢复模式 |
| [[concepts/patterns/owner-authoritative-interaction]] | Owner 模式 |
| [[entities/api/networking]] | API 速查 |

## 相关 Scene Components

- [[entities/world/scene-components/vrc-objectsync]] - **与本模式的关键区别**: `VRCObjectSync` 是**自动物理同步**模式(每帧同步 Transform),本模式是**手动状态同步**模式(按需同步变量)。决策见 `vrc-objectsync.md#与-manual-sync-区别` 决策树
- [[entities/world/scene-components/vrc-enablepersistence]] - **本模式 + 持久化**: 在 PlayerObject 上使用本模式,数据会**跨实例持久化**(100KB/玩家/World),适合"玩家解锁进度、关卡状态"等场景
