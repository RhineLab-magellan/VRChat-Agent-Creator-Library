---
title: "Hybrid Static+Dynamic Subscription (静态+动态双订阅)"
category: patterns
...
tags:
  ...
  - event
aliases:
  - "Hybrid Static+Dynamic Subscription (静态+动态双订阅)"
  - hybrid-subscription-modes.md
related:
  - channel-routing.md
  - inherited-subscriber.md
  - ../../comparisons/build-time-vs-runtime.md
  - iid-object-identity.md
  - FACT.md
type: concept
created: 2026-06-20
sources: Sardinal(参考工程)
updated: 2026-06-20
---
...
- [Sardinal（GitHub）](https://github.com/ikuko/Sardinal) — 项目溯源
- [[concepts/patterns/channel-routing]] — 配套频道路由
- [[concepts/patterns/inherited-subscriber]] — 配套基类继承
- [[comparisons/build-time-vs-runtime]] — 静态订阅数据来源
- [[concepts/patterns/iid-object-identity]] — 动态订阅类型匹配
- [[FACT]] § Sardinal
...
[Sardinal（GitHub）](https://github.com/ikuko/Sardinal) · [[channel-routing.md]] · [[inherited-subscriber.md]] · [[../../comparisons/build-time-vs-runtime.md]] · [[iid-object-identity.md]] · [[FACT|FACT]]
