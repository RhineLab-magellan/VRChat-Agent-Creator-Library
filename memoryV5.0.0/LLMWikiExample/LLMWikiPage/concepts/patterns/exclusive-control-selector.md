---
title: "Pattern: Exclusive Control Selector（互斥选择器）"
category: patterns
...
aliases:
  - 互斥选择器
  - "Exclusive Control Selector（互斥选择器）"
related:
  - bit-packed-flags.md
...
type: concept
created: 2026-06-20
sources: "QuickBrown LuraSwitch2(参考工程) — `SwitchSelector.cs`"
updated: 2026-06-20
---
...
> Pattern 核心思想(集中同步 + 子 syncMode 强制覆盖 + 1 帧延迟初始化)在 Udon 沙箱中仍是通用解法
...
[[bit-packed-flags.md]] · [[event-driven-state-machine.md]] · [[master-follower-syncer.md]] · [[advanced-sync-patterns.md]] · [[late-joiner-state-restore.md]]
