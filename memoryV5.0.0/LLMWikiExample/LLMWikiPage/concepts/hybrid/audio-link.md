...
related:
  ...
  - vcc.md
  - ../../entities/world/vrc-light-volumes.md
type: concept
created: 2026-06-21
sources: "github.com/llealloo/audiolink"
updated: 2026-06-21
---
# AudioLink 音频同步系统 API 与使用指南
...
- [[FACT]] §核心设计模式 — 模式 1-5
- [[entities/world/udon/data-containers/byte-and-bit-operations]] — 位域压缩底层原理
- [[concepts/patterns/bit-packed-flags]] — 位域压缩同步模式应用
...
[[osc-protocol.md]] · [[alcom.md]] · [[udon-world-plugins.md]] · [[vcc.md]] · [[../../entities/world/vrc-light-volumes.md]]
