...
type: concept
created: 2026-06-30
sources: "docs.vrchat.com + changelog + vrchat-community/osc + VRChat 2025.4.2p1 Release Notes"
updated: 2026-06-30
---
# VRChat OSC 协议完整数据库
...
> 完整内容详见 [[entities/world/audio-steam]] §"Voice 音量滑块范围变更"
...
如果不需要外部应用,直接在 Udon 中用 Unity Input API 读取 X 键(详见 [[entities/world/udon/input-events]] "精确按键识别限制"章节):
...
- （来源：SP 文档本地译本） (2026-06-30 抓取自 docs.vrchat.com/llms.txt)
...
[[audio-link.md]] · [[alcom.md]] · [[udon-world-plugins.md]] · [[vcc.md]] · [[../../entities/avatar/full-body-tracking.md]]
