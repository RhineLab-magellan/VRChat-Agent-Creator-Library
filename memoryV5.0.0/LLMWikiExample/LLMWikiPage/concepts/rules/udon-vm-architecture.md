...
related:
  - ../../entities/world/udon/vm-and-assembly.md
  - multi-vm-rules.md
...
type: concept
created: 2026-06-20
sources: "VRChat SDK DLL 逆向工程 (vrcd.org.cn Udon VM 研究笔记) + 官方文档 (creators.vrchat.com)"
updated: 2026-06-20
---
# Udon VM Architecture Reference
...
> **关联参考**:[[entities/world/udon/vm-and-assembly]] - 官方字节码规范(汇编语法 + Extern 签名格式)
...
- [[concepts/rules/udonsharp-language-limits]] — UdonSharp 语言限制(本 VM 架构的直接结果)
- [[entities/world/udon/vm-and-assembly]] — **官方 Udon 字节码规范**(Udon Assembly 语法、9 Opcodes 完整说明、Extern 签名格式、Udon Types 命名规则)
- [[entities/api/udon-type-exposure]] — Udon 类型暴露规则
- [[entities/world/udon/ui-events]] — UI 事件白名单(EXEC 不经 Udon VM)
- [[entities/world/udon/world-debug-views]] — Debug 视图(含 Suffering 字段、Net Objects 统计)
...
| 主题 | 本地化文档 | VM 架构关联 |
|---|---|---|
| Udon 总览 | [[entities/world/udon/index]] | 9 Opcodes 概述、类型命名规则、this 含义 |
| **事件执行顺序** ⭐ | [[entities/world/udon/event-execution-order]] | `_onEnable → _start` 无间隔,RunEventAdvanced 时序 |
| Animation Events | [[entities/world/udon/animation-events]] | 12 个 EXTERN 入口(RunProgram/SendCustomEvent/Animator) |
| Avatar Events | [[entities/world/udon/avatar-events]] | OnAvatarChanged/OnAvatarEyeHeightChanged 时序 |
| Input Events | [[entities/world/udon/input-events]] | Button/Axis 事件签名,UdonInputEventArgs |
| External URLs | [[entities/world/udon/external-urls]] | VRCUrl 白名单 + 5s 限流 |
| Image Loading | [[entities/world/udon/image-loading]] | VRCImageDownloader EXTERN 链 |
| String Loading | [[entities/world/udon/string-loading]] | VRCStringDownloader EXTERN 链 |
| AI Navigation | [[entities/world/udon/ai-navigation]] | NavMeshAgent 集成 + Owner 计算 |
| Debugging Udon | [[entities/world/udon/debugging-udon-projects]] | 错误日志 + Halt 行为 + EXTERN Debug.Log 成本 |
