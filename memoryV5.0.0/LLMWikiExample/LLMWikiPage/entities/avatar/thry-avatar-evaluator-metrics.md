---
title: "Thry Avatar Evaluator 7 项指标完整阈值"
category: avatar
...
type: entity
created: 2026-06-20
sources: "Thryrallo/VRC-Avatar-Performance-Tools v1.3.7 (AvatarEvaluator.cs + TextureVRAM.cs)"
updated: 2026-06-20
---
# Thry Avatar Evaluator 7 项指标完整阈值
...
- [VRC-Avatar-Performance-Tools（GitHub）](https://github.com/Thryrallo/VRC-Avatar-Performance-Tools) — 工具本身介绍
- [[entities/avatar/performance-rank]] — 官方 Performance Rank 标准
- [[entities/avatar/performance-benchmarks]] — JustSleightly 性能基准
- [[entities/avatar/optimization-guide]] — Kuriko 完整最佳化实操
- [[entities/avatar/ndmf-tools]] — NDMF 工具生态(AAO / Meshia / TexTransTool)
- [[entities/avatar/animator-system]] — Animator 基础知识
---

## 相关页面

[VRC-Avatar-Performance-Tools（GitHub）](https://github.com/Thryrallo/VRC-Avatar-Performance-Tools) · [[performance-rank.md]] · [[performance-benchmarks.md]] · [[optimization-guide.md]] · [[ndmf-tools.md]] · [[animator-system.md]]
