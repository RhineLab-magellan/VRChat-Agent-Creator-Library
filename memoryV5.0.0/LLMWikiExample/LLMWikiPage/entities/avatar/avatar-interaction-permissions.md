...
type: entity
created: 2026-06-30
sources: https://docs.vrchat.com/docs/permissions-and-settings
updated: 2026-06-30
---
...
> 🔗 **关联 SPS 故障**：当你的 SPS Plug 在游戏中无法对他人 socket 变形时，首先检查对方名片是否显示"黄色手"。详见 [[entities/avatar/vrcfury-reference]] §14.X。
...
| 系统 | 范围 | 文档 |
|------|------|------|
| **Interaction Permissions(本文档)** | 控制 Avatar 交互(手柄互动,Who can interact) | [[entities/avatar/avatar-interaction-permissions]] |
| **Safety System** | 控制看到其他玩家 Avatar 的特性(What you see) | [[entities/avatar/safety-system]] |
| **Trust Rank** | 决定用户上传/可见性 | [[entities/avatar/trust-rank]] |
| **Safe Mode** | 紧急屏蔽**所有**用户所有特性(Shift+Esc) | [[entities/avatar/safety-system]] §5 |
...
## 10. 与 SPS (Super Plug Shader) 的关联

Avatar Self Interact 设置与 **SPS Plug** 工作状态直接相关：

| 场景 | 关联 |
|------|------|
| **Self Interact 关闭** | SPS Plug 在编辑器中工作正常，但**游戏中不形变** |
| **Self Interact 开启** | SPS Plug 在游戏中正常形变 |
| **他人名片显示"黄色手"** | 你的 SPS Plug 可对其 socket 形变 |
| **他人名片"手图标灰色"** | 你的 SPS Plug 无法对其 socket 形变 |

**故障诊断流程**：

1. SPS Plug 编辑器 OK 但游戏失效 → 检查 `Avatar Self Interact` 是否启用
2. 自身 socket 正常，他人 socket 失效 → 检查对方名片"黄色手"
3. 深度动画/声音无效 → 触点缺失（详见 [[entities/avatar/vrcfury-reference]] §14.X）

[FACT] https://docs.vrchat.com/docs/permissions-and-settings + https://vrcfury.com/sps/

---

## 相关页面

[[../world/scene-components/vrc-scenedescriptor.md]] · [[safety-system.md]] · [[trust-rank.md]]
