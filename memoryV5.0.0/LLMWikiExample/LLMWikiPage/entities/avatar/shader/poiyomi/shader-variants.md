...
> **原始参考**: `[Poiyomi Shaders 官方文档](https://www.poiyomi.com/) + `02-render-preset.md`
> **状态**: 活跃(Active)
...
详见 [[entities/platform/easyquestswitch]](知识库已有)。
...
2. 使用 [[entities/avatar/performance-rank]] 校验等级
3. 配合 [[entities/avatar/optimization-guide]] 优化
...
[[installation.md]] · [[../../../../comparisons/poiyomi-pro-vs-toon.md]] · [[quest-optimization.md]]
