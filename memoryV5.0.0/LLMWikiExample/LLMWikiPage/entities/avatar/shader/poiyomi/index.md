...
related:
  ...
  - shader-locking-mechanism.md
  - ../index.md
type: entity
created: 2026-07-04
sources: "本地知识库整理(2026-07-01) + Poiyomi 官方文档 v10.0 完整入库"
updated: 2026-07-04
---
...
本知识库收录 Poiyomi Shaders 的**结构化知识**,由 65 个官方原始文档提炼而来。原始数据保留在 [Poiyomi Shaders 官方文档](https://www.poiyomi.com/),本目录提供**主题化、可决策的知识**。
...
| **[[shading-styles.md|Shading Styles]]** | 9 种 Lighting Type | 选择阴影风格 |
| **[quest-optimization.md](quest-optimization.md)** | Quest 优化策略 | 制作 Quest Avatar |
| **[pro-vs-toon.md](../../../../comparisons/poiyomi-pro-vs-toon.md)** | Pro vs Toon 边界 | 决定是否订阅 |
| **[comparison-liltoon.md](../../../../comparisons/poiyomi-vs-liltoon.md)** | Poiyomi vs lilToon | 选择 Shader 时 |
| **[[shader-locking-mechanism.md|Shader Locking]]** | Shader Locking 机制 + 4 种 Copy Property 选项 + VRCFury 集成 + Hue Shift 工作流 | 制作可动画化的 Poiyomi Avatar 时 |
...
2. 读 **[pro-vs-toon.md](../../../../comparisons/poiyomi-pro-vs-toon.md)** - 决定 Toon 还是 Pro
...
```
[[entities/avatar/shader/poiyomi/index]]         ← 本知识库(提炼知识)
├── index.md                          ← 本文件
...
[Poiyomi Shaders 官方文档](https://www.poiyomi.com/)                     ← 原始数据(65 个 .md)
├── INDEX.md                          ← 原始数据主索引
├── 00-introduction.md
...
详见 **[pro-vs-toon.md](../../../../comparisons/poiyomi-pro-vs-toon.md)**
...
详见 **[comparison-liltoon.md](../../../../comparisons/poiyomi-vs-liltoon.md)**
...
| 引用目标 | 位置 |
|----------|------|
| **Poiyomi 原始数据主索引** | `[Poiyomi Shaders 官方文档](https://www.poiyomi.com/) |
| **Poiyomi Introduction 原文** | `[Poiyomi Shaders 官方文档](https://www.poiyomi.com/) |
| **Poiyomi 全部 65 文档** | `[Poiyomi Shaders 官方文档](https://www.poiyomi.com/)*.md` |
