...
type: entity
created: 2026-07-01
sources: "本地知识库整理(2026-07-01) + Poiyomi 官方文档 v10.0"
updated: 2026-07-01
---
...
> **原始参考**: `[Poiyomi Shaders 官方文档](https://www.poiyomi.com/) + 相关变体说明
> **状态**: 活跃(Active)
...
**优化工具**:
- **Avatar Compressor (LAC)**: 自动压缩 → [[entities/avatar/lac-avatar-compressor]]
- **Avatar Optimizer (AAO)**: 通用优化 → [[entities/avatar/avatar-optimizer]]
...
详见 [[entities/avatar/performance-rank]] §Quest 等级。
...
详见 [[entities/avatar/avatar-dynamic-bone-limits]] + [[entities/avatar/avatar-particle-system-limits]]。
...
详见 [[entities/platform/easyquestswitch]]。
...
Quest 也支持 **VRC Light Volumes**(社区开源项目 REDSIM/VRCLightVolumes，v.2.1+ 稳定，含 Quest 优化参数),但需要调低参数。来源: [VRCLightVolumes GitHub](https://github.com/REDSIM/VRCLightVolumes)。
...
详见 [[entities/world/vrc-light-volumes]] §Quest 章节。
...
| **EasyQuestSwitch** | [[entities/platform/easyquestswitch]] |
...
[[shader-variants.md]] · [[../../../../comparisons/poiyomi-pro-vs-toon.md]] · [[audiolink-integration.md]] · [[../../performance-rank.md]] · [[../../optimization-guide.md]]
