...
related:
  ...
  - shader-variants.md
  - modular-system.md
  - ../../../../concepts/hybrid/osc-protocol.md
type: entity
created: 2026-07-01
...
> **原始参考**: `[Poiyomi Shaders 官方文档](https://www.poiyomi.com/) + `12-al-spectrum.md` + `62-volume-color.md`
> **状态**: 活跃(Active)
...
> **AudioLink 基础**: 详见 `https://audiolink.dev/`,本知识库 [[concepts/hybrid/osc-protocol]] 有 OSC 集成说明。
...
| 引用目标 | 位置 |
|----------|------|
| **AudioLink 基础 原文** | `[Poiyomi Shaders 官方文档](https://www.poiyomi.com/) |
| **AL Spectrum 原文** | `[Poiyomi Shaders 官方文档](https://www.poiyomi.com/) |
| **AL Volume Color 原文** | `[Poiyomi Shaders 官方文档](https://www.poiyomi.com/) |
...
[[installation.md]] · [[shader-variants.md]] · [[modular-system.md]] · [[../../../../concepts/hybrid/osc-protocol.md]]
