...
> **原始参考**: `[Poiyomi Shaders 官方文档](https://www.poiyomi.com/) + `01-download-install.md`
> **状态**: 活跃(Active)
...
| **忘装 VRC SDK** | 无法上传 Avatar | 先装 VRChat SDK 3.5.0+ |
...
[[../../../../comparisons/poiyomi-pro-vs-toon.md]] · [[shader-variants.md]] · [Poiyomi 官方](https://poiyomi.com/)
