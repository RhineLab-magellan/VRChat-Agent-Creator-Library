...
>
> **2026-07-01 更新**: Poiyomi Shaders 65 个文档已完整入库,详情见 `[Poiyomi Shaders 官方文档](https://www.poiyomi.com/)
...
├── [Poiyomi Shaders 官方文档](https://www.poiyomi.com/)   ← Poiyomi 65 个文档(完整)
│   └── INDEX.md
...
> **2026-07-01 完成**: 65 个文档从 `https://www.poiyomi.com/intro` 系统化下载,详见 `[Poiyomi Shaders 官方文档](https://www.poiyomi.com/)
...
| **文档版本** | 10.0 |
| **本地路径** | `[Poiyomi Shaders 官方文档](https://www.poiyomi.com/) |
...
**详细文档**：[[entities/world/shader/graphlit]]
...
> 📌 VRCFury 是 Avatar 自动化**工具**（不是 Shader），不在本知识库范围内。详见 [[entities/avatar/vrcfury-reference]]
...
[[../performance-rank.md]] · [[index.md]] · [[scss.md]] · [[../../../comparisons/filamented-comparison.md]] · [[liltoon/reflection-settings.md]]
