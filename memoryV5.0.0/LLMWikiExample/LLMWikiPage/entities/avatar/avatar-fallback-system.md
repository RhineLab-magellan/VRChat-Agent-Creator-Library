...
changelog: "2026-07-04 新增 §Quest Fallback 硬性规则 + Mobile Rank 速查表"
confidence: High
type: entity
created: 2026-07-04
sources: https://docs.vrchat.com/docs/avatar-fallback-system
updated: 2026-07-04
---
...
## 1.1 Quest Fallback 硬性规则（2026-07 补充）

> **来源**:
> - docs.vrchat.com/docs/avatar-fallback-system（FACT-OFFICIAL）
> - wiki.vrchat.com/wiki/Guides:Avatar_Performance_Ranking（FACT-WIKI）
> **状态**: ✅ FACT-OFFICIAL + FACT-WIKI
...
| 条件 | 说明 | 来源 |
|------|------|------|
| 1. **Performance Rank: Good 或 Excellent** | 基于 Android/Quest 评级标准 | docs.vrchat.com |
| 2. **三角形数 ≤ 10,000** | Good 评级上限（Excellent 为 7,500） | VRChat Wiki Mobile Rank |
| 3. **平台覆盖完整** | 必须同时上传 Windows + Android/Quest | docs.vrchat.com |
| 4. **Fallback 标志** | Android 上传时必须设置 Fallback 标记 | docs.vrchat.com |

### 评级阈值速查（VRChat Wiki Mobile Rank Table）

| 指标 | Excellent | **Good（Fallback 最低）** | Medium | Poor |
|------|-----------|--------------------------|--------|------|
...
### Grandfathered Fallback 规则

- **2021-09-01 前上传**的 Fallback: 已纳入新规则
- 缺失 Windows 资产: Windows 端显示为"Perf Blocked"机器人
- 缺失 Android 资产: 显示为随机颜色机器人 + 缩略图

### 引用

- [VRChat Docs] Avatar Fallback System: <https://docs.vrchat.com/docs/avatar-fallback-system>
- [VRChat Wiki] Avatar Performance Ranking: <https://wiki.vrchat.com/wiki/Guides:Avatar_Performance_Ranking>
...
- **可解决**:
  ...
  - 对方创作者:优化 Avatar
- **参考**: [[entities/avatar/performance-rank]]
...
- [[entities/avatar/thry-avatar-evaluator-metrics]] — 7 项检测指标
- [[entities/avatar/optimization-guide]] — 优化实操
- [[entities/platform/cross-platform-content]] — 跨平台开发
- [[entities/platform/android-development]] — Quest 端要求
- [[entities/platform/easyquestswitch]] — PC/Quest 切换工具
...
[[performance-rank.md]] · [[thry-avatar-evaluator-metrics.md]] · [[optimization-guide.md]] · [[../platform/cross-platform-content.md]] · [[../platform/android-development.md]]
