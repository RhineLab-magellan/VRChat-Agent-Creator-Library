...
type: entity
created: 2026-06-30
sources: https://docs.vrchat.com/docs/avatar-particle-system-limits
updated: 2026-06-30
---
...
- [[entities/avatar/optimization-guide]] — Particle System 优化
- [[entities/avatar/avatar-dynamic-bone-limits]] — 用户端 DB Limits(同 config.json)
- [[entities/platform/android-development]] — Quest 端开发
...
[[performance-rank.md]] · [[optimization-guide.md]] · [[avatar-dynamic-bone-limits.md]] · [[../platform/android-development.md]]
