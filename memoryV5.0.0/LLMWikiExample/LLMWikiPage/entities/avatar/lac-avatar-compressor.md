...
type: entity
created: 2026-06-21
sources: "github.com/limitex/avatar-compressor"
updated: 2026-06-21
---
# Avatar Compressor (LAC)
...
> ⚠️ Quest 平台严禁使用 DXT/BC 系列（详见 [[entities/platform/android-development]]）
...
LAC 直接改善 [[entities/avatar/performance-rank]] 中的 **Texture Memory** 指标（PC < 75MB Good / < 40MB Excellent）。
...
| **需要 Unity 2022.3.22f1** | 与 VRChat 强制版本绑定（详见 [[_always-load]] 核心约束） |
...
- [[entities/avatar/ndmf-tools]] — NDMF 工具生态总览（LAC 在 AAO 之前执行）
- [[entities/avatar/optimization-guide]] — Texture Memory 优化原则（LAC 自动化了这些原则）
- [[entities/avatar/performance-rank]] — 性能等级标准（LAC 主要改善 Texture Memory 指标）
- [[entities/platform/android-development]] — Quest 平台贴图格式限制
- [[entities/platform/easyquestswitch]] — PC/Quest 平台切换工具
- [[entities/avatar/modular-avatar]] — NDMF 框架基础
...
[[ndmf-tools.md]] · [[optimization-guide.md]] · [[performance-rank.md]] · [[../platform/android-development.md]] · [[../platform/easyquestswitch.md]] · [[modular-avatar.md]]
