...
> 配套文档: [[entities/avatar/modular-avatar]](主文档)
> 教学法归属: [[entities/avatar/teaching-methodology]]
...
- **Blend Shape 排障**:如果菜单 toggle 涉及 Shape Changer / 形态键,详见 `blend-shape-troubleshooting.md` §4 步法
- **骨绑定**:菜单项驱动的衣服/配饰若涉及绑定,详见 `bone-binding-workflow.md` §决策树
...
[[avatar-modding-guide.md]] · [[ma-component-cards.md]] · [[ma2bt.md]] · [[modular-avatar.md]] · [[animator-system.md]]
