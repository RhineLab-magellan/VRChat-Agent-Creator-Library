...
| 现有知识 | 关联 |
|---|---|
| [[entities/world/items]] | Layer 3 (`Item`) 详述、Items 与 Udon 不可交互 |
| [[entities/api/udon-type-exposure]] | `Utilities.IsValid` 暴露状态 |
| [[concepts/rules/networking-rules]] | Networked Object Layer 选择 |
| （来源：Example Central，本地整理） | Pickup / Mirror 示例参考实现 |
| [[entities/api/pickups]] | Layer 13/14 (`Pickup`, `PickupNoEnvironment`) 行为 |
