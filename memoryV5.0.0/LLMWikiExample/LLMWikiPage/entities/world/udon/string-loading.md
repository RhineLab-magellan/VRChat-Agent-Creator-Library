...
> 详细: [[entities/world/udon/external-urls]]
...
> VRCJson + Data Containers 详细: [[entities/world/udon/data-containers/index]] ⭐
...
- **External URLs + 白名单**: [[entities/world/udon/external-urls]] ⭐
- **Image Loading**: [[entities/world/udon/image-loading]] ⭐ 类似机制
- **Data Containers + VRCJson**: [[entities/world/udon/data-containers/index]] ⭐ JSON 解析
- **Udon 事件**: [[entities/api/events-reference]] ⭐ OnStringLoad* 签名
- **Persistence**: [[entities/api/persistence]] ⭐ 与 String Loading 的取舍
...
- [String Loading](https://creators.vrchat.com/worlds/udon/string-loading) - 本页官方原版
- [External URLs](https://creators.vrchat.com/worlds/udon/external-urls) - URL 白名单
- [Image Loading](https://creators.vrchat.com/worlds/udon/image-loading) - 图片下载
- [Data Containers](https://creators.vrchat.com/worlds/udon/data-containers/) - JSON 处理

---

## 相关页面

[[ai-navigation.md]] · [[animation-events.md]] · [[avatar-events.md]] · [[debugging-udon-projects.md]] · [[event-execution-order.md]]
