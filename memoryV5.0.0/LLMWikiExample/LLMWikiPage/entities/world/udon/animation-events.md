---
title: Animation Events - Animator 事件白名单
category: world
subcategory: udon
...
| 数量 | **13 个方法**(很窄) | **28 个组件**(很广) |
| 主要用法 | 同步动画时间 + Udon 逻辑 | UI 直接控制组件 |

> UI Events 完整白名单: [[entities/world/udon/ui-events]] ⭐ 28 个组件 100+ 成员
...
> 详细 Animator 系统: [[entities/world/udon/udonsharp/compilation]] 和 [[entities/api/animator]]
...
- **UI Events 白名单**: [[entities/world/udon/ui-events]]
- **Udon 事件完整参考**: [[entities/api/events-reference]]
- **Animator API**: [[entities/api/animator]]
- **UdonSharp 编译管线**: [[entities/world/udon/udonsharp/compilation]]

---

## 相关 VRChat 官方文档

- [Animation Events](https://creators.vrchat.com/worlds/udon/animation-events)
- [Unity Animation Window Events](https://docs.unity3d.com/2022.3/Documentation/Manual/script-AnimationWindowEvent.html)
- [UdonSharp Event Nodes](https://creators.vrchat.com/worlds/udon/graph/event-nodes)

---

## 相关页面

[[index.md]] · [[vrctween/index.md]] · [[ui-events.md]] · [[event-execution-order.md]]
