...
type: entity
created: 2026-06-20
sources: "https://creators.vrchat.com/worlds/udon/players/player-avatar-scaling/ (Last updated: 2023-07-28)"
updated: 2026-06-20
---
# Player Avatar Scaling — Avatar 缩放系统
...
| [[entities/api/animator]] | Avatar 缩放影响 Animator IK 目标(待补充) |
| [[entities/avatar/playable-layers]] | Avatar 端缩放控制(独立于本文件的世界端控制) |
| [[entities/world/udon/avatar-events]] | `OnAvatarChanged` / `OnAvatarEyeHeightChanged` 事件 |

---

## 相关页面

[[player-audio.md]] · [[player-positions.md]] · [[getting-players.md]] · [[player-collisions.md]] · [[player-forces.md]]
