...
type: entity
created: 2026-06-20
sources: "https://creators.vrchat.com/worlds/udon/players/ (Last updated: 2026-03-04)"
updated: 2026-06-20
---
# Player API 总览 (VRCPlayerApi)
...
> 📌 **底层引用**: [[entities/api/player-api]] 错误案例 — "缓存 VRCPlayerApi 引用过长(玩家离开后引用失效)"
...
- **重要**: 与 Sync 强相关,详见 [[entities/api/networking]]
...
| 现有知识库 | 关系 |
|---|---|
| [[entities/api/player-api]] | **底层 API 总览**(简略版),本文件为**应用层详解** |
| [[entities/api/events-reference]] | 玩家事件回调 (`OnPlayerJoined`/`OnPlayerLeft`/`OnPlayerSuspendChanged` 等),应补充 3 个 Drone Trigger 事件 |
| [[entities/world/udon/players/index]] | 本目录其他 6 个子页面 |
| [[entities/world/udon/players/drones/index]] | **Drone API 子分类** (task-12 已完成,3 个 .md) |
