...
type: entity
created: 2026-06-20
sources: "https://creators.vrchat.com/worlds/udon/players/drones/ (Last updated: 2026-03-07)"
updated: 2026-06-20
---
# Drone API 总览 (VRCDroneApi)
...
>
> 详见 [`getting-drones.md`](getting-drones.md) 与 [[entities/world/udon/players/player-collisions]] 的对比。
...
| [[entities/api/player-api]] | 底层 `VRCPlayerApi` 文档,**`GetDrone()`** 是其延伸 |
| [[entities/api/events-reference]] | 应补充 3 个 Drone Trigger 事件 |
| [[entities/world/udon/players/player-collisions]] | Player Collisions 兄弟页面,Drone 与 Player Trigger 平行 |
