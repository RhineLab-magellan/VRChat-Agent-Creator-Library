...
- [[entities/world/udon/data-containers/index]] - VRCJson / DataList / DataDictionary 详解
- [[entities/world/udon/networking/variables]] - UdonSynced 字段类型
- [[entities/world/examples/persistence/playerdata-types]] - 18 种类型演示示例

---

## 相关页面

[[../../../api/persistence.md]] · [[../index.md]] · [[player-data.md]] · [[player-object.md]] · [[limits-and-quirks.md]]
