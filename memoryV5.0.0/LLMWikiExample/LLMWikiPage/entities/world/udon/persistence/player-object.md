...
type: entity
created: 2026-06-21
sources: VRChat Creator Docs(https://creators.vrchat.com/worlds/udon/persistence/player-object/)
updated: 2026-06-21
---
# PlayerObject 实战
...
- [[entities/api/persistence]] - 完整 API 速查
- [[entities/world/udon/networking/ownership]] - 所有权机制详解
- [[entities/world/udon/networking/variables]] - UdonSynced 字段类型
- [[entities/world/examples/persistence/health-bar]] - 血条 Example
- [[entities/world/examples/persistence/position-sync]] - 位置同步 Example
- [[entities/world/examples/persistence/simple-rpg]] - RPG Example
...
[[../../../api/persistence.md]] · [[../index.md]] · [[player-data.md]] · [[serialization.md]] · [[limits-and-quirks.md]] · [[patterns/persistent-pen.md]] · [[../networking/ownership.md]]
