...
type: entity
created: 2026-06-21
sources: VRChat Creator Docs(https://creators.vrchat.com/worlds/udon/persistence/)
updated: 2026-06-21
---
# Persistence 实战教程 - 索引
...
> 定位:**实战教程**(非 API 参考,API 速查见 [[entities/api/persistence]])
...
| 知识库文件 | 关系 |
|-----------|------|
| [[entities/api/persistence]] | **API 速查表**(本文是实战教程) |
| [[entities/world/examples/persistence/index]] | 9 个 Example Central 官方示例笔记 |
| [[entities/world/udon/index]] | Udon 总览(VM 关系 + 3 种创建方式) |
| [[entities/world/udon/networking/index]] | 网络同步(与 PlayerObject 强相关) |
...
| [ClientSim（VRChat 官方）](https://creators.vrchat.com/worlds/clientsim/) | ClientSim 编辑器模拟(含 PlayerData 调试窗口) |
