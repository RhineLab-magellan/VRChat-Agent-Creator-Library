...
type: entity
created: 2026-06-21
sources: VRChat Creator Docs(https://creators.vrchat.com/worlds/examples/persistence/unlock-items/)
updated: 2026-06-21
---
# 解锁物品实现(Pattern)
...
- [[entities/world/udon/persistence/player-data]] - PlayerData 详细 API
- [[entities/world/udon/persistence/limits-and-quirks]] - 100KB 限制
- [[entities/world/examples/persistence/unlock-items]] - 官方 Example Central 笔记
- [[entities/world/examples/persistence/persistent-idle-game]] - Idle Game(类似模式)
- [[entities/world/udon/persistence/patterns/leaderboard]] - 排行榜模式

---

## 相关页面

[[../../../../api/persistence.md]] · [[../../index.md]] · [[../player-data.md]] · [[../serialization.md]] · [[../limits-and-quirks.md]] · [[../../../examples/persistence/unlock-items.md]] · [[../../../examples/persistence/persistent-idle-game.md]]
