...
- 详见 [[concepts/rules/udon-vm-architecture]]
...
- **Udon VM 架构**: [[concepts/rules/udon-vm-architecture]] ⭐ EXTERN 机制
- **Udon 性能规则**: [[concepts/rules/performance-rules]] ⭐ Debug.Log 成本
- **UdonSharp 运行时**: [[entities/api/udonsharp-runtime]] ⭐ 异常监听机制
- **Udon 编译管线**: [[entities/world/udon/udonsharp/compilation]] ⭐ Build 错误排查
...
[[ai-navigation.md]] · [[external-urls.md]] · [[image-loading.md]] · [[ui-events.md]] · [[vm-and-assembly.md]]
