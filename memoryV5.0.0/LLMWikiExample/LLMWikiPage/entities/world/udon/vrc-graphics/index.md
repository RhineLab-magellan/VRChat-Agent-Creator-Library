...
> SDK: 3.5.0+
> 父文档: [[entities/world/udon/vrc-graphics/index]] 自身(原 [[entities/world/udon/vrc-graphics/index]] 已删除,内容已整合至本文件及子页面)
> 子页面: [[entities/world/udon/vrc-graphics/asyncgpureadback|asyncgpureadback]]、[[entities/world/udon/vrc-graphics/vrchat-shader-globals|vrchat-shader-globals]]、[[entities/world/udon/vrc-graphics/vrc-rendertexture|vrc-rendertexture]]
> 互链文档: [[entities/world/vrc-camera-settings]]、[[entities/world/vrc-quality-settings]]
...
| **VRCCameraSettings** | `VRC.SDK3.Rendering` (推断) | 屏幕/手持相机访问、VR 双眼位置 | [[entities/world/vrc-camera-settings]] |
| **VRCQualitySettings** | `VRC.SDK3.Rendering` (推断) | 质量设置只读访问 + 阴影距离覆盖 | [[entities/world/vrc-quality-settings]] |
...
- [[entities/world/udon/vrc-graphics/asyncgpureadback]] — AsyncGPUReadback 详细
- [[entities/world/udon/vrc-graphics/vrchat-shader-globals]] — `_VRChat*` 全局变量详细
- [[entities/world/udon/vrc-graphics/asyncgpureadback]] (旧版,如有) — 历史参考
- [[entities/world/performance-guide]] — 渲染性能优化
- [[entities/avatar/shader/index]] — Avatar Shader 全局变量集成
- [[concepts/rules/udonsharp-language-limits]] — UdonSharp 语言限制(末尾已补充 VRC Graphics 限制)
- [[entities/api/udon-type-exposure]] — 暴露类型清单(VRCGraphics/VRCShader 已确认在 `Rendering` 命名空间)
