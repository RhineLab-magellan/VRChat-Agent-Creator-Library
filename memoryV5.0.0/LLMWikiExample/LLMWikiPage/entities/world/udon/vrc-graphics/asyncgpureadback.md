...
> SDK: 3.5.0+
> 父文档: [[entities/world/udon/vrc-graphics/index]] (本文件即父文档内 VRC Graphics 体系一部分,原 [[entities/world/udon/vrc-graphics/index]] 占位页已删除)
...
- [[entities/world/udon/vrc-graphics/index]] — VRC Graphics 总览
- [[concepts/hybrid/audio-link]] — 音频同步系统 API 完整架构(深度使用 readback)
- [[entities/api/udon-type-exposure]] — `Rendering` 命名空间 7 个类型(VRCAsyncGPUReadback 等)
...
[[index.md]] · [[../../../../concepts/hybrid/audio-link.md]] · [[../../../api/udon-type-exposure.md]]
