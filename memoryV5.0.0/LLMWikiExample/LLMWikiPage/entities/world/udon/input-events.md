...
`VRCInputMethod` 枚举详见 [Type Nodes 文档](https://creators.vrchat.com/worlds/udon/graph/type-nodes/#vrcsdkbasevrcinputmethod)。
...
- **Udon 事件完整参考**: [[entities/api/events-reference]] ⭐ InputXxx 事件签名
- **Collision/Trigger 事件**: [[entities/api/events-reference]] ⭐ OnTriggerXxx/OnCollisionXxx
- **Interact 事件**: [[entities/api/events-reference]] ⭐ Interact()
- **UI Events**: [[entities/world/udon/ui-events]] ⭐ UI 事件白名单(不同机制)
- **Animation Events**: [[entities/world/udon/animation-events]] ⭐ Animator 事件白名单
- **OSC 输入控制**: [[concepts/hybrid/osc-protocol]] ⭐ Input Control API(注意:官方 OSC 不暴露 X/Y/A/B)
- **Avatar Expression Parameters**: [[entities/avatar/playable-layers]] ⭐ Avatar 端 VR InputDriver 绑定

---

## 相关 VRChat 官方文档

- [Input Events](https://creators.vrchat.com/worlds/udon/input-events) - 本页官方原版
...
[[animation-events.md]] · [[avatar-events.md]] · [[event-execution-order.md]] · [[ui-events.md]]
