...
> **详细示例分析**: [[entities/world/examples/ai-navigation]] ⭐ 完整代码 + 网络同步模式
...
- **完整 AI Navigation 示例**: [[entities/world/examples/ai-navigation]] ⭐ 包含 Manual Sync 模式
- **Networking 模式**: [[entities/api/networking]] ⭐ Manual + Owner Authority
- **VRCObjectSync**: [[entities/world/sdk-prefabs]] ⭐ 自动位置同步
- **VRC Pickup**: [[entities/world/whitelisted-world-components]]
- **NavMesh API 暴露**: [[entities/api/udon-type-exposure]] → Grep "NavMesh"

---

## 相关 VRChat 官方文档

- [AI Navigation 完整指南](https://creators.vrchat.com/worlds/udon/ai-navigation)
...
[[debugging-udon-projects.md]] · [[external-urls.md]] · [[image-loading.md]] · [[ui-events.md]] · [[vm-and-assembly.md]]
