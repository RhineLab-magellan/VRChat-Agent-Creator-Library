---
title: "Avatar Events - 玩家 Avatar 变更事件"
category: world
subcategory: udon
...
> 抓取日期: 2026-06-15
> 状态: ✅ FACT (官方文档)
> 关联: [[entities/api/events-reference]]
...
> 玩家切换 Avatar 或使用 [Avatar Scaling](https://creators.vrchat.com/worlds/udon/players/player-avatar-scaling) 系统导致 **Eye Height 变化**时触发。
...
> 详细事件执行顺序: [[entities/world/udon/event-execution-order]] ⭐ **关键文档**
...
> 详细 Avatar Scaling 系统: [[entities/world/udon/players/player-avatar-scaling]]
...
- **Udon 事件完整参考**: [[entities/api/events-reference]] ⭐
- **事件执行顺序**: [[entities/world/udon/event-execution-order]] ⭐ 关键时序
- **Player API**: [[entities/api/player-api]] ⭐
- **Player Avatar Scaling**: [[entities/world/udon/players/player-avatar-scaling]] ⭐

---

## 相关 VRChat 官方文档

- [Avatar Events](https://creators.vrchat.com/worlds/udon/avatar-events)
...
[[animation-events.md]] · [[event-execution-order.md]] · [[input-events.md]] · [[udon-moderation-tool-guidelines.md]] · [[ui-events.md]]
