...
> 详细 Image Loading: [[entities/world/udon/image-loading]] ⭐ VRCImageDownloader 用法
> 详细 String Loading: [[entities/world/udon/string-loading]] ⭐ VRCStringDownloader 用法
...
- **Image Loading**: [[entities/world/udon/image-loading]] ⭐ VRCImageDownloader
- **String Loading**: [[entities/world/udon/string-loading]] ⭐ VRCStringDownloader
- **UI Events**: [[entities/world/udon/ui-events]] ⭐ VRCUrlInputField 在 UI 事件白名单内
- **Udon 事件**: [[entities/api/events-reference]] ⭐ OnStringLoad* 事件

---

## 相关 VRChat 官方文档

- [External URLs](https://creators.vrchat.com/worlds/udon/external-urls) - 本页官方原版
- [Image Loading](https://creators.vrchat.com/worlds/udon/image-loading) - 图像下载详细
- [String Loading](https://creators.vrchat.com/worlds/udon/string-loading) - 字符串下载详细

---

## 相关页面

[[ai-navigation.md]] · [[debugging-udon-projects.md]] · [[image-loading.md]] · [[ui-events.md]] · [[vm-and-assembly.md]]
