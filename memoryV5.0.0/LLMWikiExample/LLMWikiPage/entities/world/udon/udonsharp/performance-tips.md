---
title: "UdonSharp Performance Tips"
category: world
subcategory: udon
...
type: entity
created: 2026-06-20
sources: "creators.vrchat.com/worlds/udon/udonsharp/performance-tips"
updated: 2026-06-20
---
# UdonSharp Performance Tips
...
**【FACT - [[entities/api/udonsharp-runtime]] / 视频播放器(参考工程)验证】**：
...
**【FACT - [[concepts/patterns/manual-sync-state]] 验证】**：
...
> **【未确认】** 网络同步性能影响未在官方 performance-tips 中直接讨论，但 [[entities/api/networking]] 中有详细带宽限制（~11KB/s、280KB/serialization）。
...
**【FACT - [ClientSim（VRChat 官方）](https://creators.vrchat.com/worlds/clientsim/) 验证】** ClientSim 模拟 VRChat 客户端环境，可用于：
- 在 Editor 中测试 U# 性能
- 验证同步行为
- 无需进入 VRChat 实例即可调试
...
| 现有知识库 | 应补充/引用 |
|-----------|----------|
| [[entities/api/networking]] | 同步模式选择与带宽限制 |
| [[concepts/patterns/manual-sync-state]] | Manual Sync + 阈值触发范式 |
| [[concepts/patterns/owner-authoritative-interaction]] | Owner Authority 模式 |
| [[entities/api/udonsharp-runtime]] | Odin Serializer、GetProgramVariable 性能 |
| [[entities/world/performance-guide]] | World 综合性能（材质、光照）|
| [ClientSim（VRChat 官方）](https://creators.vrchat.com/worlds/clientsim/) | 性能测试环境 |
| [[concepts/rules/udonsharp-language-limits]] | 语言限制（无 Generic 等）的性能影响 |
...
[[attributes.md]] · [[compilation.md]] · [[configuration.md]] · [[editorscripting.md]] · [[../data-containers/byte-and-bit-operations.md]]
