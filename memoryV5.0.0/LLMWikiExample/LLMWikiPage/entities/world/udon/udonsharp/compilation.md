...
type: entity
created: 2026-06-15
sources: "vrchat-community/UdonSharp (DeepWiki, commit 5d1a2b3d) + creators.vrchat.com/worlds/udon/udonsharp/"
updated: 2026-06-15
---
# UdonSharp 编译管线

UdonSharp 1.x **迁移说明**: 本文档为 [[entities/world/udon/udonsharp/compilation]] 的权威位置。
...
- [[entities/world/udon/udonsharp/index]] — UdonSharp 总览
- [[entities/world/udon/udonsharp/configuration]] — UdonSharp 配置
- [[entities/world/udon/udonsharp/attributes]] — UdonSharp Attributes
- [[entities/world/udon/udonsharp/performance-tips]] — 性能优化
- [[concepts/rules/udonsharp-language-limits]] — UdonSharp 语言限制
- [[concepts/rules/udon-vm-architecture]] — Udon VM 架构
- [[entities/api/udonsharp-runtime]] — UdonSharpBehaviour 运行时系统
- [[entities/world/udon/vm-and-assembly]] — Udon 字节码规范
...
[[index.md]] · [[configuration.md]] · [[attributes.md]] · [[performance-tips.md]] · [[../../../../concepts/rules/udonsharp-language-limits.md]] · [[../../../../concepts/rules/udon-vm-architecture.md]] · [[../../../api/udonsharp-runtime.md]] · [[../vm-and-assembly.md]]
