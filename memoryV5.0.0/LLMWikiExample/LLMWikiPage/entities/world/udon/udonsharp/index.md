...
type: entity
created: 2026-06-20
sources: "creators.vrchat.com/worlds/udon/udonsharp/"
updated: 2026-06-20
---
# UdonSharp - VRChat SDK C# 编程前端
...
> **注**：`class-exposure-tree`（类暴露树）已本地化到 [[entities/api/udon-type-exposure]]，本目录不重复创建。
...
**【FACT】** 是的。Udon 支持的所有功能 U# 都能访问。可通过 [Class Exposure Tree](https://github.com/MerlinVR/UdonSharp/wiki/class-exposure-tree) 验证（已本地化到 [[entities/api/udon-type-exposure]]）。
...
| 现有知识库 | 应补充/引用 |
|-----------|----------|
| [[entities/api/udonsharp-runtime]] | 引用 [`attributes.md`](attributes.md)、[`performance-tips.md`](performance-tips.md) |
| [[entities/api/udon-type-exposure]] | **互链** — 类暴露树的本地化位置 |
| [[entities/api/exposed-types]] | 引用本文 §2 Supported C# Features |
| [[entities/api/not-exposed]] | 引用本文 §3、§4 |
| [[concepts/rules/udonsharp-language-limits]] | 引用 [`attributes.md`](attributes.md)、[`performance-tips.md`](performance-tips.md) |
| [[entities/world/udon/vm-and-assembly]] | 配合阅读（U# 是 C# 前端，VM 是运行时） |
...
- **【未确认】** `class-exposure-tree` 官方 URL 内容已迁移至 [[entities/api/udon-type-exposure]]，两者同步状态需定期验证
