...
type: entity
created: 2026-06-20
sources: "creators.vrchat.com/worlds/udon/udonsharp/attributes"
updated: 2026-06-20
---
# UdonSharp Attributes
...
| 现有知识库 | 应补充/引用 |
|-----------|----------|
| [[entities/api/networking]] | **核心** — 详细的 UdonSynced、RequestSerialization、NetworkEvent、NetworkCallable 机制 |
| [[concepts/patterns/manual-sync-state]] | 引用本文 §3.3 `Manual` 模式 |
| [[concepts/patterns/owner-authoritative-interaction]] | 引用本文 §3.3 `Manual` 模式 |
| [[concepts/rules/udonsharp-language-limits]] | 引用本文 §2.3 同步模式 |
| [[entities/api/udonsharp-runtime]] | FieldChangeCallback 配合 [UdonSynced] 使用 |
...
**【FACT - [[entities/api/networking]] 已记录】** 用于声明方法可**远程调用并传递参数**。
...
> **【未确认】** 官方 attributes 页面未列出此 Attribute，详细信息见 [[entities/api/networking]]。

### 5.3 `[FieldChangeCallback]`

**【FACT - [[entities/api/udonsharp-runtime]] 已记录】** 字段变化时**自动触发回调**。
...
- **【未确认】** 多个 `[UdonSynced]` 字段在同一次 `RequestSerialization` 调用中的**带宽聚合**行为（需配合 [[entities/api/networking]] 带宽限制理解）

---

## 相关页面

[[../../../api/networking.md]] · [[FACT|FACT]] · [[compilation.md]] · [[configuration.md]] · [[editorscripting.md]]
