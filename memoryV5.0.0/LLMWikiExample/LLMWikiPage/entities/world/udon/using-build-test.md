...
> 关联:[ClientSim（VRChat 官方）](https://creators.vrchat.com/worlds/clientsim/) - 替代的编辑器内模拟方案
...
参考 [ClientSim（VRChat 官方）](https://creators.vrchat.com/worlds/clientsim/) 获取详细信息。
...
| 相关文档 | 用途 |
|----------|------|
| [ClientSim（VRChat 官方）](https://creators.vrchat.com/worlds/clientsim/) | Edit 模式内模拟(轻量替代) |
| [[entities/world/udon/ui-events]] | UI 事件测试 |
| [[entities/world/udon/world-debug-views]] | Debug 视图 |
| [[entities/api/persistence]] | PlayerData 完整 API |
| [[entities/api/networking]] | 网络同步测试 |
...
[[animation-events.md]] · [[avatar-events.md]] · [[ui-events.md]] · [[ai-navigation.md]] · [[debugging-udon-projects.md]]
