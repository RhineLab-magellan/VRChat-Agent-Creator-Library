...
type: entity
created: 2026-06-15
sources: "VRChat 官方 Creator Docs (Network Events)"
updated: 2026-06-15
---
# Network Events 网络事件
...
| [[entities/world/udon/networking/late-joiners]] | Late Joiner 与 Event 关系 |
| [[entities/world/udon/networking/variables]] | 变量同步(状态持久化) |
| [[entities/world/udon/networking/ownership]] | Owner 模式 + 事件 |
| [[entities/api/networking]] | API 速查 |
| [[entities/api/udon-type-exposure]] | Udon Type Exposure |

---

## 相关页面

[[index.md]] · [[late-joiners.md]] · [[variables.md]] · [[ownership.md]] · [[../../../api/networking.md]] · [[../../../api/udon-type-exposure.md]]
