...
type: entity
created: 2026-06-15
sources: "VRChat 官方 Creator Docs (Network Components)"
updated: 2026-06-15
---
# Network Components 网络组件
...
> 详见 [[entities/api/persistence]] 和 [[entities/world/index]]。
...
| [[entities/world/udon/networking/events]] | 完整事件列表 |
| [[entities/world/udon/networking/ownership]] | 所有权 API 详解 |
| [[entities/world/udon/networking/variables]] | synced 变量 |
| [[entities/world/udon/networking/late-joiners]] | Late Joiner 同步 |
| [[entities/world/udon/networking/debugging]] | Network 调试 |
| [[entities/api/networking]] | API 速查 |
| [[entities/api/persistence]] | PlayerData/PlayerObject 配额 |

---

## 相关页面

[[index.md]] · [[events.md]] · [[ownership.md]] · [[variables.md]] · [[late-joiners.md]] · [[debugging.md]] · [[../../../api/networking.md]] · [[../../../api/persistence.md]]
