...
type: entity
created: 2026-06-15
sources: "VRChat 官方 Creator Docs (Object Ownership)"
updated: 2026-06-15
---
# Object Ownership 对象所有权
...
| [[entities/world/udon/networking/events]] | SendCustomNetworkEvent(Owner 模式) |
| [[entities/world/udon/networking/variables]] | synced 变量写入权限 |
| [[entities/world/udon/networking/network-components]] | VRCPickup 自动所有权 |
| [[entities/api/networking]] | API 速查 |
| [[concepts/patterns/owner-authoritative-interaction]] | Owner 模式实现 |

---

## 相关页面

[[index.md]] · [[events.md]] · [[variables.md]] · [[network-components.md]] · [[../../../api/networking.md]] · [[../../../../concepts/patterns/owner-authoritative-interaction.md]]
