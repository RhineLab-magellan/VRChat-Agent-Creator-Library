...
type: entity
created: 2026-06-15
sources: "VRChat 官方 Creator Docs (Networking Specs & Tricks)"
updated: 2026-06-15
---
# Networking Specs & Tricks 内部细节
...
### 设计补充提醒
- 若一个系统同时依赖大量布尔 / 小枚举字段，可优先考虑在架构层重新分组，必要时再引入位域压缩。
- 先问“哪些状态真的值得同步”，再问“如何把更多状态塞进同一包”。
...
| [[entities/world/udon/networking/variables]] | synced 变量类型 |
| [[entities/world/udon/networking/performance]] | 性能优化 |
| [[entities/world/udon/networking/debugging]] | 调试方法 |
| [[entities/world/udon/networking/network-components]] | VRCObjectSync 等 |
...
[[index.md]] · [[variables.md]] · [[performance.md]] · [[debugging.md]] · [[network-components.md]] · [[../../../api/networking.md]]
