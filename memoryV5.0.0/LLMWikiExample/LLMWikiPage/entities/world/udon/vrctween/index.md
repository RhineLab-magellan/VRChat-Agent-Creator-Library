...
type: entity
created: 2026-06-22
sources: VRChat Creator Docs (https://creators.vrchat.com/worlds/udon/vrctween/)
updated: 2026-06-22
---
...
> **校对状态** (2026-06-22): 本知识库 7 个本地化文档与官方 2026-05-28 版本**逐项对齐**,覆盖率 >95%。逐字校验项包括 11 个 Control Methods、6 个 Query Properties、8 个 Settings、31 种 Ease 速查、`OnRewind`/`ChangeEndValue`/`From`/`SetSpeedBased` 等行为细节。无结构更新需求,见 ``JOURNAL`` 2026-06-22 审计记录。
