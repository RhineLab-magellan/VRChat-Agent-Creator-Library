...
type: entity
created: 2026-06-30
sources: "本地知识库整理 + VRChat 2026.1.1 / 2026.1.1 Open Beta Release Notes"
updated: 2026-06-30
---
# World Debug Views - VRChat Debug 视图
...
> 关联:[[entities/api/networking]](Network Stats API)
...
参考 [[entities/api/networking]] 完整列表,核心 API:
...
| 相关文档 | 用途 |
|----------|------|
| [[entities/api/networking]] | Network Stats API 完整参考 |
| [[entities/world/udon/using-build-test]] | Build & Test 多客户端 |
| [[entities/world/udon/vm-and-assembly]] | 字节码级调试 |
| [[entities/avatar/physbones]] | PhysBone 组件参考（含 World 端 Udon 调试） |
...
详见 [[entities/world/audio-steam]] §4(Steam Audio Debug 字段)与本章节配合使用。

---

## 相关页面

[[avatar-events.md]] · [[udon-moderation-tool-guidelines.md]] · [[ui-events.md]] · [[ai-navigation.md]] · [[animation-events.md]]
