...
type: entity
created: 2026-06-30
sources: "本地知识库整理 + VRChat 2026.2.3p1 Release Notes"
updated: 2026-06-30
---
# Image Loading - 远程图片加载
...
> **官方推荐**: 查看 [Image Loader Example](https://creators.vrchat.com/worlds/examples/image-loading) 快速开始
> **本地化示例**: [[entities/world/examples/image-loading]] ⭐ 完整 Prefab + GitHub Pages
...
- [[entities/world/examples/image-loading]] - 完整图片加载示例
- [[entities/api/events-reference]] - OnImageLoadSuccess 事件签名

---

## 与知识库互补

- **完整 Image Loading 示例**: [[entities/world/examples/image-loading]] ⭐ SlideshowFrame Prefab
- **External URLs + 白名单**: [[entities/world/udon/external-urls]] ⭐
- **String Loading**: [[entities/world/udon/string-loading]] ⭐ 类似机制
- **Udon 事件**: [[entities/api/events-reference]] ⭐ OnImageLoad* 事件

---

## 相关 VRChat 官方文档

- [Image Loading](https://creators.vrchat.com/worlds/udon/image-loading) - 本页官方原版
- [Image Loader Example](https://creators.vrchat.com/worlds/examples/image-loading) - 官方示例

---

## 相关页面

[[ai-navigation.md]] · [[debugging-udon-projects.md]] · [[external-urls.md]] · [[ui-events.md]] · [[vm-and-assembly.md]]
