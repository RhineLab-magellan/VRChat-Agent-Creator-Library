...
type: entity
created: 2026-06-30
sources: "本地知识库整理 + VRChat 2026.1.2p2 Release Notes"
updated: 2026-06-30
---
# Event Execution Order - 事件执行顺序
...
> 抓取日期: 2026-06-15
> 状态: ✅ FACT (官方文档,**关键文档**)
> 关联: [[entities/api/events-reference]] ⭐ 事件方法签名
...
> 来自 [[concepts/rules/udon-vm-architecture]] 的事件执行流程:
...
> 详细: [[entities/world/udon/avatar-events]]
...
> 来自 [[concepts/rules/udon-vm-architecture]]
...
> 详细: [[entities/api/udonsharp-runtime]]
...
- **Udon VM 架构**: [[concepts/rules/udon-vm-architecture]] ⭐ RunEventAdvanced 机制
- **UdonSharp 运行时**: [[entities/api/udonsharp-runtime]] ⭐ FieldChangeCallback
- **Networking 序列化**: [[entities/api/networking]] ⭐ OnPre/Post/Deserialization
- **Avatar 事件**: [[entities/world/udon/avatar-events]] ⭐ Avatar 加载时序
- **Animation 事件**: [[entities/world/udon/animation-events]] ⭐ Animator 时序

---

## 相关 VRChat 官方文档

- [Event Execution Order](https://creators.vrchat.com/worlds/udon/event-execution-order) - 本页官方原版
...
- [[entities/api/events-reference]] - 自定义事件绑定
...
[[animation-events.md]] · [[avatar-events.md]] · [[input-events.md]] · [[ui-events.md]] · [[ai-navigation.md]]
