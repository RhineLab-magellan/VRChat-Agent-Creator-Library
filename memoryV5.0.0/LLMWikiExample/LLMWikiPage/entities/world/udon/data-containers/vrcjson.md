...
type: entity
created: 2026-06-21
sources: VRChat Creator Docs(https://creators.vrchat.com/worlds/udon/data-containers/vrcjson/)
updated: 2026-06-21
---
...
>
> 详见 [[entities/api/udon-type-exposure]]。
...
- **网络同步**: [[entities/api/networking]] — JSON 同步模式
- **未暴露 API**: [[entities/api/not-exposed]] — .NET JsonUtility 不可用原因
- **类型暴露**: [[entities/api/udon-type-exposure]] — Udon 白名单
...
[[index.md]] · [[byte-and-bit-operations.md]] · [[data-tokens.md]] · [[data-lists.md]] · [[data-dictionaries.md]] · [[../../../api/data-containers.md]]
