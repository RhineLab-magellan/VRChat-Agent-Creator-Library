...
>
> 配套必读:位域压缩同步模式 → [[concepts/patterns/bit-packed-flags]]
...
UdonSharp **完整支持 C# 位运算符**,这是位域压缩同步模式 ([[concepts/patterns/bit-packed-flags]]) 的基础。
...
> **来源**: [[concepts/hybrid/audio-link]] 位域压缩模式(参考工程)
...
| 现有知识库 | 关联 |
|-----------|------|
| [[entities/world/udon/data-containers/index]] | **父文档**:Data Containers 概述 |
| [[concepts/patterns/bit-packed-flags]] | **核心模式**:位域压缩同步 (本任务是其底层原理) |
| [[concepts/hybrid/audio-link]] | **案例**:音频同步系统 _flags 字段(参考工程) |
| [[entities/api/networking]] | **带宽限制** (~11KB/s, Manual 280KB) |
| [[entities/api/not-exposed]] | **白名单确认**:BitConverter/Buffer 已暴露 |
...
位域压缩需求?
  ↓
看 [[concepts/patterns/bit-packed-flags]] (使用模式)
  ↓
看本文档 (字节/位操作底层原理)
  ↓
看 [[concepts/hybrid/audio-link]] (实际案例)
  ↓
看 [[entities/api/networking]] (带宽预算)
```
...
- [[entities/world/udon/data-containers/index]] — Data Containers 父文档
- [[concepts/patterns/bit-packed-flags]] — 位域压缩同步模式 ⭐
- [[concepts/hybrid/audio-link]] — 音频同步系统位域压缩案例(参考工程)
- [[entities/api/networking]] — 带宽限制 (~11KB/s, Manual 280KB)
- [[entities/api/not-exposed]] — 白名单黑名单
- [[entities/api/udon-type-exposure]] — Udon Type Exposure 索引
...
[[index.md]] · [[../../../../concepts/patterns/bit-packed-flags.md]] · [[../../../../concepts/hybrid/audio-link.md]] · [[../../../api/networking.md]] · [[../../../api/not-exposed.md]] · [[../../../api/udon-type-exposure.md]]
