...
| 子页面 | 路径 | 核心内容 | 状态 |
|--------|------|---------|------|
| **Data Tokens** | [`./data-tokens.md`](data-tokens.md) | DataToken 类型系统 + 隐式装箱 + 提取值 | ✅ 2026-06-21 |
| **Data Lists** | [`./data-lists.md`](data-lists.md) | DataList 完整 API + 嵌套 + 性能基准 | ✅ 2026-06-21 |
| **Data Dictionaries** | [`./data-dictionaries.md`](data-dictionaries.md) | DataDictionary 完整 API + 键值对 | ✅ 2026-06-21 |
| **VRCJSON** | [`./vrcjson.md`](vrcjson.md) | JSON 序列化/反序列化 + 错误处理 | ✅ 2026-06-21 |
| **Byte and Bit Operations** | [`./byte-and-bit-operations.md`](byte-and-bit-operations.md) | 位运算 + BitConverter + Buffer | ✅ 已存在 |

> **本索引页**提供 Data Containers 速览,**详细 API/性能/陷阱**请看上面 5 个子页面。
...
8 个独立 `[UdonSynced] bool` → 1 个 `[UdonSynced] byte`,**节省 87.5% 序列化空间**。详见 [[concepts/patterns/bit-packed-flags]]。
...
- [[entities/world/udon/data-containers/byte-and-bit-operations]] — **位/字节操作**
- [[entities/world/udon/data-containers/performance-notes|性能基准]] — DataList/DataDictionary 性能开销（推断）+ 实测清单
- [[entities/api/networking]] — 网络同步模式
- [[concepts/patterns/bit-packed-flags]] — 位域压缩模式
- [[concepts/rules/udonsharp-language-limits]] — 集合类型限制（List/Dictionary 禁用）
...
| 日期 | 操作 | 说明 |
|------|------|------|
| 2026-06-21 | **补全 A13** | 新增 4 个子页面(data-tokens/data-lists/data-dictionaries/vrcjson)⭐ |
