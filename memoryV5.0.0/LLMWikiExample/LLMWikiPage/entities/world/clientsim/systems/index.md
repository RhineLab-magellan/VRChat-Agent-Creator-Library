...
| **Editor** | Unity Editor 内的辅助系统(场景设置、Inspector) | [[entities/world/clientsim/systems/editor|editor]] |
| **Runtime** | Play Mode 中模拟 VRChat 行为的系统 | [[entities/world/clientsim/systems/runtime|runtime]] |
| **Script Execution Order** | 11 个核心系统的 Unity 脚本执行顺序 | [[entities/world/clientsim/systems/script-execution-order|script-execution-order]] |
