...
related:
  - ../../../systems/index.md
  - playerobject-editor.md
  - playerdata-editor.md
  - ../../../systems/architecture.md
  - ../../../systems/editor.md
  - ../../../systems/runtime.md
  - ../../../systems/script-execution-order.md
type: entity
created: 2026-06-20
sources: 本地知识库整理
updated: 2026-06-20
...
- [[entities/world/clientsim/playerobject-editor|PlayerObject Editor]] - 调试 PlayerObject
- [[entities/world/clientsim/playerdata-editor|PlayerData Editor]] - 调试 PlayerData
- [Systems](systems/index.md) - 内部架构与子系统
  - [Architecture](systems/architecture.md) - 观察者 + 依赖注入
  - [[entities/world/clientsim/systems/editor|Editor]] - Editor 子系统
  - [[entities/world/clientsim/systems/runtime|Runtime]] - Runtime 子系统
  - [[entities/world/clientsim/systems/script-execution-order|Script Execution Order]] - 11 个系统执行顺序

## 相关引用

- [ClientSim（VRChat 官方）](https://creators.vrchat.com/worlds/clientsim/) - ClientSim **项目仓库**元数据(发展历史、双向同步、贡献流程),与本目录的**用户使用文档**互补
- （来源：Example Central，本地整理） - Example Central 中涉及的 ClientSim 相关引用
