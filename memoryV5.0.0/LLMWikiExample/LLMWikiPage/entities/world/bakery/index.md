---
title: "Bakery GPU Lightmapper 知识库"
category: world
subcategory: bakery
knowledge_level: applied
status: active
source: "geom.io/bakery/wiki/"
source_type: community
version: 1.1
last_review: 2026-07-04
changelog: "2026-07-04 §1.1 追加 PC ↔ Android 切换后重新烘焙注释"
confidence: Medium
tags:
  - misc
  - index
...
### 1.1 平台切换后重新烘焙（2026-07 补充）

> **来源**: VRCD 20-vowgan.md (COMMUNITY) + 工程经验【推断】
> **状态**: ⚠️ COMMUNITY

PC ↔ Android 平台切换后，World 项目需**重新烘焙光照**。这是因为光烘焙数据（Lightmap, Light Probe, Reflection Probe）的存储格式与目标平台相关。

**实操建议**:
- 首次切换到 Android 时**预留 30-60 分钟**烘焙时间
- Quest 端 Lightmap Resolution 推荐 **1024-2048**（比 PC 低）
- 烘焙后用 ClientSim 在 Android 模拟器上验证
- 详细约束见 [[concepts/rules/quest-constraints]] §2.1.1
...
- [[entities/world/bakery/light-baking-guide|光照烘焙深度指南]]
