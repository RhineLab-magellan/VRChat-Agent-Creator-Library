...
related:
  - ../udon/launch-options.md
  - ../udon/using-build-test.md
  - ../udon/debugging-udon-projects.md
  - ../vvmw.md
...
type: entity
created: 2026-06-30
sources: docs.vrchat.com/docs/using-vrchat-in-a-virtual-machine
updated: 2026-06-30
---
...
> - **合规性结论【未确认】**: 当前页面未直接给出 ToS 条款原文，不能仅凭本页将其表述为“明确不违反 EAC ToS / VRChat ToS”。更稳妥的说法是：官方提供了研究性质文档，但不提供支持，也不承诺长期可用。
