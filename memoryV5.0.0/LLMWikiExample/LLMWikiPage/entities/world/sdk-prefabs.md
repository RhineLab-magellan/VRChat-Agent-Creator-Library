...
- **相关知识**: [[entities/api/pickups]]（Pickup 触发模式）
...
> "An example of how to use [VRC_PortalMarker](https://creators.vrchat.com/worlds/components/vrc_portalmarker)."
...
> "An example of how to use [VRC_SceneDescriptor](https://creators.vrchat.com/worlds/components/vrc_scenedescriptor) to define a VRChat World."
...
> "An example of how to create an Udon-powered [Video Player](https://creators.vrchat.com/worlds/udon/video-players/)."
...
| 现有知识 | 关联 Prefab |
|---|---|
| （来源：Example Central，本地整理） | Example Central 提供更多高级示例 |
| [[entities/world/items]] | VRCMirror 反射 Item 的修复 |
| [[entities/world/udon/data-containers/index]] | VideoSync 可能使用 DataToken 存储 URL |
| [[entities/world/creator-economy]] | Store API 可在 Pedestal 中集成 |
| [[entities/api/networking]] | Udon Variable Sync 演示同步机制 |
| [[entities/api/pickups]] | Pedestal / Chair 都是基于 Pickup/Interactable 模式 |
...
- **相关知识**: （来源：Example Central，本地整理） (更高级示例)
- **相关知识**: [[entities/world/creator-economy]] (Store API 集成)
