...
related:
  - vvmw.md
  - ../../concepts/hybrid/udon-world-plugins.md
  - ../../concepts/patterns/master-follower-syncer.md
  - ../../concepts/patterns/exclusive-control-selector.md
  - ../../concepts/patterns/soft-detent-interpolation.md
  - ../../concepts/patterns/fade-then-snap.md
  - ../../concepts/patterns/editor-preview-component.md
  - ../../concepts/patterns/material-propertyblock-safe-update.md
  - performance-guide.md
  - ../../concepts/rules/networking-rules.md
  - ../api/persistence.md
...
type: entity
created: 2026-06-21
sources: QuickBrown LuraSwitch2 + lurathunder 文档站
updated: 2026-06-21
---
...
> **对 Agent 的意义**:该 Prefab 集已沉淀出 6 个**通用 Udon 模式**(参见 [LuraSwitch2（Lura Booth）](https://lura.booth.pm/)),
...
### 通用模式(6 个)→ [[concepts/patterns/index]]
...
### 溯源 → [LuraSwitch2（Lura Booth）](https://lura.booth.pm/)
...
**作为知识来源时**:
> 来源:[LuraSwitch2（Lura Booth）](https://lura.booth.pm/)(基于 v3.00 案例研究 + 6 个 Pattern 来源)
> 工具使用:[[entities/world/luraswitch2]](本文档,基于 v1.06 重写)
...
| [[concepts/patterns/soft-detent-interpolation]] | 软吸附(来自本项目) |
| [[concepts/patterns/fade-then-snap]] | 淡入淡出(来自本项目) |
| [[concepts/patterns/editor-preview-component]] | Editor 预览(来自本项目) |
| [[concepts/patterns/material-propertyblock-safe-update]] | MPB 共享材质(来自本项目) |
| （来源：常见失败案例分析，本地整理） | FAIL-29 ~ FAIL-32 |
| [[entities/world/performance-guide]] | World 性能优化(背景知识) |
| [[concepts/rules/networking-rules]] | 网络同步规则 |
| [[entities/api/persistence]] | PlayerData API(LocalSave 用) |
| [[entities/platform/cross-platform-content]] | PC/Quest 平台适配 |
