...
related:
  ...
  - ../../../../concepts/patterns/event-driven-state-machine.md
type: entity
created: 2026-06-20
sources: 本地知识库整理
updated: 2026-06-20
...
| **VRCWorldSettings**(Udon Graph) | 调整玩家移动速度(详见 [[entities/world/examples/udon-example-scene/player-mod-setter|player-mod-setter]]) |
| **Avatar Scaling Settings**(Udon Graph) | 限制 Avatar 缩放范围(详见 [[entities/world/examples/udon-example-scene/avatar-scaling-settings|avatar-scaling-settings]]) |
...
**参见**:[[entities/api/networking]] 的 Manual Sync 模式
...
**参见**:[[entities/api/networking]] 所有权系统
...
**详见** [[entities/world/examples/udon-example-scene/udon-video-sync-player|udon-video-sync-player]]
...
**详见** [[entities/world/examples/udon-example-scene/simple-pen-system|simple-pen-system]]
...
- **Networking 模式**:[[entities/api/networking]] 包含 Manual Sync / Continuous 完整规范
- **Pickup 行为**:[[entities/api/pickups]] 包含 VRCPickup / VRCObjectSync 完整 API
- **UI 转发**:[[entities/api/ui]] 包含 VRC_UIShape 使用规范
- **性能基线**:[[entities/world/performance-guide]] 可引用本场景作为 **基础性能基线**
- **事件驱动状态机**:[[concepts/patterns/event-driven-state-machine]] 关联 Sync 程序的 Variable Change 事件模式
...
- **Udon Graph 限制**:本场景部分程序仅提供 Udon Graph 版本,无 UdonSharp 等价实现(如 `VRCWorldSettings`);部分有两者(参见 [[entities/world/examples/udon-example-scene/player-mod-setter|player-mod-setter]])
- **World Audio Settings**:**当前不在 SDK 示例场景中**(详见 [[entities/world/examples/udon-example-scene/world-audio-settings|world-audio-settings]])
