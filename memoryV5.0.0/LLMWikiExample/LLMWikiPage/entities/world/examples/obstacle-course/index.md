---
title: "Obstacle Course(障碍赛 / World Jam 2)"
category: world
...
- 子:
  - [[entities/world/examples/obstacle-course/build-from-custom-parts|Build From Custom Parts]]
  - [[entities/world/examples/obstacle-course/build-from-demo-parts|Build From Demo Parts]]
  - [[entities/world/examples/obstacle-course/uoc-flythrough|Flythrough(预览相机)]]
  - [[entities/world/examples/obstacle-course/uoc-how-stuff-works|How Stuff Works(内部机制)]]
  - [[entities/world/examples/obstacle-course/uoc-window|Obstacle Course Toolkit(Editor 窗口)]]
...
- **Editor 工具链对比**:Toolkit 窗口属于 Editor-only 工具,与 （来源：Example Central，本地整理） 中的 Example Central、ClientSim 工具同属"VRChat 官方 Editor 工具"范式
- **Object Pool 模式**:PlayerDataManager 使用 `VRCObjectPool` 模式,建议在 [[concepts/patterns/index]] 考虑新增 `object-pool.md` 模式文档
