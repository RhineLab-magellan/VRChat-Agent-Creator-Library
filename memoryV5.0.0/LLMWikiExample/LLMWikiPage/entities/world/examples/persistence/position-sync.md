...
type: entity
created: 2026-06-20
sources: "https://creators.vrchat.com/worlds/examples/persistence/position-sync/"
updated: 2026-06-20
---
# Position Sync(位置同步)

> SDK Version: 3.4.x+
> 关联底层: [[entities/api/persistence]]
...
可与 [[entities/api/networking]] 中的同步机制互链:
