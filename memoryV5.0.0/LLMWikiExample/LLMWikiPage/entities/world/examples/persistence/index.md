...
type: entity
created: 2026-06-20
sources: "https://creators.vrchat.com/worlds/examples/persistence/"
updated: 2026-06-20
---
# Persistence Examples - 索引
...
| # | 示例 | 数据层 | 核心 API | 文档 |
|---|------|--------|----------|------|
| 1 | **Health Bar** | PlayerObject | `VRCPlayerObject` + 血量同步 | [[entities/world/examples/persistence/health-bar|health-bar]] |
| 2 | **Leaderboard** | PlayerData | `PlayerData.SetFloat/TryGetFloat` | [leaderboard.md](leaderboard.md) |
| 3 | **Persistent Idle Game** | PlayerData | `PlayerData` + `OnPlayerRestored` | [[entities/world/examples/persistence/persistent-idle-game|persistent-idle-game]] |
| 4 | **Persistent Pen** | PlayerObject | `VRCPlayerObject` + `VRCEnablePersistence` | [persistent-pen.md](persistent-pen.md) |
| 5 | **Player Data Types** | PlayerData | 18 种支持数据类型演示 | [[entities/world/examples/persistence/playerdata-types|playerdata-types]] |
| 6 | **Position Sync** | PlayerObject | 0.5s 周期 + `OnPlayerRestored` | [[entities/world/examples/persistence/position-sync|position-sync]] |
| 7 | **Post-Processing Settings** | PlayerData | `OnPlayerDataUpdated` + Slider | [[entities/world/examples/persistence/post-processing-settings|post-processing-settings]] |
| 8 | **Simple RPG** | PlayerObject | `UdonSynced` 变量自动持久化 | [[entities/world/examples/persistence/simple-rpg|simple-rpg]] |
...
- [[entities/api/persistence]] - 底层 API 参考(PlayerData / PlayerObject 完整方法签名)
- [[entities/api/networking]] - `[UdonSynced]` 网络同步机制(与 PlayerObject 互链)
- （来源：Example Central，本地整理） - Example Central 使用指南
- [ClientSim（VRChat 官方）](https://creators.vrchat.com/worlds/clientsim/) - ClientSim 编辑器模拟(支持 PlayerData 调试窗口)
