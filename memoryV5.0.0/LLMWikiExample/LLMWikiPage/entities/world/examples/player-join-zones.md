...
- 详细参考 [[entities/api/udonsharp-runtime]]
...
- **DataList / DataDict**: [[entities/world/udon/data-containers/index]] ⭐ 直接互链
- **FieldChangeCallback**: [[entities/api/udonsharp-runtime]] ⭐
- **SetProgramVariable 模式**: [[entities/api/udonsharp-runtime]] ⭐
- **OnPlayerTriggerStay 完整 API**: [[entities/api/events-reference]]
- **AvatarEyeHeight**: [[entities/api/player-api]](待建)
- **Mute Others(基于区域静音)**: [[entities/world/examples/mute-others]] ⭐ Challenge 提示直接引用本示例

## 相关 Udon 文档链接

- [DataList 完整文档](https://creators.vrchat.com/worlds/udon/data-containers/data-lists)
- [FieldChangeCallback 完整文档](https://udonsharp.docs.vrchat.com/udonsharp/#fieldchangecallback)
- [Player Collisions - Trigger](https://creators.vrchat.com/worlds/udon/players/player-collisions)
