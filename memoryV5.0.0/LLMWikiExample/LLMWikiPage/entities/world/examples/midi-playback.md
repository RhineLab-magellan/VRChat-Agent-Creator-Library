...
- **VRC SDK3 MIDI 命名空间**: [[entities/vrchatsdk/homepage|VRChat SDK]]
- **AudioLink 系统**: [[audio-link]](参考音频驱动视觉的另一种方式)

## 相关 Udon 文档链接

- [VRCMidiPlayer Component](https://creators.vrchat.com/worlds/udon/midi/midi-playback/#component-vrcmidiplayer)
- [MIDI Note On Event](https://creators.vrchat.com/worlds/udon/midi#midinoteon)
- [MIDI Note Off Event](https://creators.vrchat.com/worlds/udon/midi#midinoteoff)
