...
- **Player Collisions 完整 API**: [[entities/api/events-reference]] 中的 Player Collisions 章节
- **VRCPlayerApi**: [[entities/api/player-api]](待建)
- **Trigger 事件**: [[contact]]

## 相关 Udon 文档链接

- [Player Collisions - Physics](https://creators.vrchat.com/worlds/udon/players/player-collisions#physics)
