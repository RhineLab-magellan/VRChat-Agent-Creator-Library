...
- **IsUserInVR 详细行为**: [[entities/api/player-api]](待建)
- **VRC_UIShape 详细使用**: [[entities/platform/mobile-ui-optimization]] ⭐
- **TeleportTo API**: [[entities/api/events-reference]] 中 Player Positions 章节
- **ClientSim 已知限制**: [ClientSim（VRChat 官方）](https://creators.vrchat.com/worlds/clientsim/) ⭐
- **EditorOnly Tag**: ``unity``(待建)

## 相关 Udon 文档链接

- [VRCPlayerApi.IsUserInVR](https://udonsharp.docs.vrchat.com/vrchat-api/#vrcplayerapi)
- [TeleportTo API](https://creators.vrchat.com/worlds/udon/players/player-positions/#teleportto)
- [VRC_UIShape 完整文档](https://creators.vrchat.com/worlds/components/vrc_uishape)
- [ClientSim 模拟器](https://creators.vrchat.com/worlds/clientsim)
