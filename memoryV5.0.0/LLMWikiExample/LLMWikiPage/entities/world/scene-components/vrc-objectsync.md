...
status: active
source: "本地知识库整理 + VRChat 2026.2.2 / 2026.2.3 / 2026.3.1 Open Beta Release Notes"
...
related:
  - ../../api/networking.md
  - ../../api/pickups.md
  - ../../../concepts/patterns/manual-sync-state.md
  - ../../../concepts/patterns/owner-authoritative-interaction.md
  - ../../api/events-reference.md
  - vrc-scenedescriptor.md
type: entity
created: 2026-07-26
sources: "本地知识库整理 + VRChat 2026.2.2 / 2026.2.3 / 2026.3.1 Open Beta Release Notes"
updated: 2026-07-26
---
# VRC Object Sync ⭐
...
> 官方类名: `VRCObjectSync`
> 最新更新日期: 2025-03-07 (基础) / 2026-06-22 (2026.2.3 Build 1864 可靠性增强,2026.2.3p1 回滚) / 2026-07-22 (2026.3.1 Open Beta Build 1878 重新启用)

---

## 🔄 2026.3.1 Open Beta — 重新启用可靠性增强 (Build 1878)

> **FACT** (2026.3.1 Open Beta Build 1878,2026-07-22):"Greatly improved the reliability of VRCObjectSync, specifically around ensuring that the final state after motion is the same between all players in an instance."
>
> **🔴 重要**:此修复**曾在 2026.2.3 Build 1864 上线,后因内部原因在 2026.2.3p1 回滚**(revert for internal reasons)。2026.3.1 Open Beta Build 1878 重新带回。

### 回滚-重启用时间线

| 版本 | 状态 | 说明 |
|------|------|------|
| 2026.2.3 Build 1864 (2026-06-22) | ✅ 首次上线 | 运动后最终状态跨玩家一致 |
| 2026.2.3p1 (2026-06-25) | 🔴 回滚 | "for internal reasons",官方未公开具体原因 |
| 2026.2.3p2 (2026-07-08) | — | 未提及,仍为回滚状态 |
| 2026.2.3p3 (2026-07-14) | — | 未提及,仍为回滚状态 |
| **2026.3.1 Open Beta Build 1878 (2026-07-22)** | ✅ **重新启用** | "Déjà vu? We had that one in 2026.2.3, but needed to revert it for internal reasons. This release brings it back!" |

> **创作者影响**:
> - 现行 Live 版本(2026.2.3p3, Build 1867)**不具备**此增强(已回滚)
> - 仅 Open Beta(2026.3.1 Build 1878+)具备;需等正式版发布后才进入主流
> - 现有 VRCObjectSync 用法**无需修改**,行为自动改善
> - 设计意图保持:配合 Outgoing Queue Drop Policy,最终状态必达,中间帧可丢弃

---

## 🔄 2026.2.3 可靠性增强 (Build 1864,已回滚)

> **FACT** (2026.2.3 Build 1864,2026-06-22):"Greatly improved the reliability of VRCObjectSync, specifically around ensuring that the final state after motion is the same between all players in an instance."

### 改进内容

| 改进点 | 表现 |
|--------|------|
| **运动后最终状态一致性** | 物理对象停止后,**所有玩家看到的最终位置/旋转完全一致** |
| **中间帧可丢弃** | 拥塞时中间帧可能丢失(配合 2026.2.1 Outgoing Queue Drop Policy),但**最终状态永远传输** |
| **远端追赶** | 非 Owner 端会平滑"追赶"到最终位置 |

### 创作者影响

| 影响 | 说明 |
|------|------|
| **物理确定性** | 物理模拟(球落地、推车停下)的一致性提升 |
| **无代码改动** | 现有 VRCObjectSync 用法无需修改 |
| **设计意图** | 配合 Outgoing Queue Drop Policy,降低中间数据优先,保证最终一致 |

### 历史修复

| 版本 | 修复 |
|------|------|
| 2025.4.2 | `VRCObjectSync` transforms not respawning in their original location |
| 2025.3.4 | 物理同步稳定性 |
| **2026.2.3** | **运动后最终状态跨玩家一致**(Build 1864) |
| 2026.2.3p1 | **回滚**上述增强(for internal reasons) |
| **2026.3.1 Open Beta** | **重新启用**上述增强(Build 1878,2026-07-22) |
...
- **Manual Sync 模式**: [../../../concepts/patterns/manual-sync-state.md](../../../concepts/patterns/manual-sync-state.md)
- **Owner 权威交互**: [../../../concepts/patterns/owner-authoritative-interaction.md](../../../concepts/patterns/owner-authoritative-interaction.md)
- **物理对象生命周期**: 待建设（原计划链接 `patterns/physics-object-lifecycle.md`，当前 Vault 内尚未存在）
