...
1. **精简字段**: 只持久化必要数据
2. **使用位域压缩**: 多个 bool 用一个 byte(参见 [../udon/data-containers/byte-and-bit-operations.md](../udon/data-containers/byte-and-bit-operations.md))
3. **避免大字符串**: 字符串压缩率低
...
- **数据容器 (VRCJson / VRCDataList)**: [../udon/data-containers/index.md](../udon/data-containers/index.md)
- **字节位运算**: [../udon/data-containers/byte-and-bit-operations.md](../udon/data-containers/byte-and-bit-operations.md)
...
- 数据容器参考: [../udon/data-containers/index.md](../udon/data-containers/index.md)
