...
Tags are VRChat's way to grant access, assign restrictions, or attach other kinds of metadata to various to objects e.g. worlds, users and avatars. These tags are in the form of simple strings, grouped together in a string array, and commonly prefixed with a namespace designating the type of tag.
...
Tags based off of the ISO 639-3 language codes. Language tags primarily appear on User profiles, with each user being allowed to have at most 3 language tags.
...
| `language_asf` | Auslan | Australian Sign Language |
...
| `language_ell` | Ελληνικά | Modern Greek |
...
| `language_gla` | Gàidhlig | Scottish Gaelic |
...
| `language_ukr` | українська | Ukrainian |
...
These are meaningless tags used by various community members:
...
- `system_cute_robot`
- `system_not_cute`
- `system_smart_fridge_beta`
- `system_trust_sussy`
- `system_lizard`
- And many more humorous/meaningless tags
---

## 相关页面

[[api-avatars.md]] · [[api-favorites.md]] · [[model-user.md]] · [[model-current-user.md]] · [[typescript-sdk.md]]
