...
type: entity
created: 2026-06-20
sources: "UdonSharp 官方文档 (udonsharp.docs.vrchat.com/events/)"
updated: 2026-06-20
---
...
> **来源**: VRChat 官方 MIDI 文档 ([[entities/world/udon/midi/index]])
...
详细文档:
- 总览与事件: [[entities/world/udon/midi/index]]
- 文件回放(`VRCMidiPlayer` 组件): [[entities/world/udon/midi/midi-playback]]
- 实时输入(`VRC Midi Listener` 组件): [[entities/world/udon/midi/realtime-midi]]
...
> 10 个 Udon 核心单页已本地化到 [[entities/world/udon/index]],涵盖事件、输入、动画、外部资源、调试等基础系统。

| 主题 | 本地化文档 | 关联内容 |
|---|---|---|
| Udon 总览 | [[entities/world/udon/index]] | 概念、3 种创建方式、VM 细节、9 条指令 |
| **事件执行顺序** ⭐关键 | [[entities/world/udon/event-execution-order]] | `_onEnable → _start` 无间隔执行 |
| Animation Events | [[entities/world/udon/animation-events]] | Animator 事件白名单 (12 方法) |
| Avatar Events | [[entities/world/udon/avatar-events]] | OnAvatarChanged / OnAvatarEyeHeightChanged |
| Input Events | [[entities/world/udon/input-events]] | Interact/InputUse/InputJump/InputGrab + UdonInputEventArgs |
| UI Events | [[entities/world/udon/ui-events]] | Unity UI 事件白名单 (28 组件) |
| Debugging | [[entities/world/udon/debugging-udon-projects]] | Debug 模式 + 错误日志 + UdonSharp 异常监听 |
| External URLs | [[entities/world/udon/external-urls]] | VRCUrl + 域白名单 + 5s 限流 |
| Image Loading | [[entities/world/udon/image-loading]] | VRCImageDownloader + 2048x2048 + 32MB |
| String Loading | [[entities/world/udon/string-loading]] | VRCStringDownloader + 100MB |
| AI Navigation | [[entities/world/udon/ai-navigation]] | NavMeshAgent + 运行时 NavMesh + Owner 计算 |
| VM and Assembly | [[entities/world/udon/vm-and-assembly]] | 字节码逆向、9 Opcode、类型命名规则 |
| Using Build & Test | [[entities/world/udon/using-build-test]] | 本地测试流程 |
...
[[networking.md]] · [[api-checker.md]] · [[pickups.md]] · [[audio.md]] · [[data-containers.md]]
