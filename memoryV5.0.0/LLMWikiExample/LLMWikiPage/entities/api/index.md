...
## Obsidian MOC — API 可点击入口

| 分类 | 入口 | 说明 |
|---|---|---|
| 核心交互 | [[player-api.md]] · [[events-reference.md]] · [[pickups.md]] · [[dynamics.md]] | 玩家、事件、拾取、Dynamics |
| 原生朝向 / 挂载（2026-08-13 预告） | [[vrc-billboard.md]] | VRCBillboard 原生公告板（Register/Unregister） |
| 网络与持久化 | [[networking.md]] · [[persistence.md]] · [[vrchat-advanced-apis.md]] | 同步、持久化、VRCGraphics / Quality / Drones / MIDI |
| 渲染与媒体 | [[animator.md]] · [[audio.md]] · [[ui.md]] | Animator、AudioSource、Unity UI |
| Udon 暴露与运行时 | [[udonsharp-runtime.md]] · [[udon-type-exposure.md]] · [[exposed-types.md]] · [[not-exposed.md]] · [[api-checker.md]] | 运行时反射、暴露树、黑名单与检查器 |
| 官方澄清 | [[official-doc-clarifications.md]] | 官方文档陷阱、碰撞/同步/事件时序澄清 |
...
| **[vrc-billboard.md](vrc-billboard.md)（2026-08-13 预告）** | 原生公告板 API 类（PLANNED） | `VRCBillboard.Register/Unregister` |
...
| 关系 | 目录 |
|------|------|
| **应用层详解** | [[entities/world/udon/networking/index]] （10 个文档） |
| **语言限制** | [[concepts/rules/udonsharp-language-limits]] |
| **API 暴露规则** | [[entities/api/udon-type-exposure]] |
| **设计模式** | [[concepts/patterns/index]] |
| **场景组件** | [[entities/world/scene-components/index]] |
| **VRChat 官方文档本地化** | [[entities/world/udon/index]] （15+ 文档） |
...
| 官方开发者更新（PLANNED） | Tier A（待发布复核） | vrc-billboard.md |
