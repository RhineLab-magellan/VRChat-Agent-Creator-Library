...
type: entity
created: 2026-06-21
sources: 本地知识库整理(基于 VRChat 官方文档)
updated: 2026-06-21
---
...
详见 [[concepts/rules/udonsharp-language-limits]] 和 [[entities/api/not-exposed]]。
...
- **位域压缩**: [[concepts/patterns/bit-packed-flags]] — 字节级压缩
- **Udon 限制**: [[concepts/rules/udonsharp-language-limits]] — C# List/Dictionary 不可用
- **未暴露 API**: [[entities/api/not-exposed]] — JsonUtility 不可用原因
